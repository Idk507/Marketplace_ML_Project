...
NYC TLC Trip Record Data for large-scale trip, time, geography, fare, and ETA/demand modeling.
Chicago Taxi Trips for persistent vehicle-level identity, fare/revenue information, trip outcomes, and driver/vehicle-ranking proxies.
IEEE-CIS Fraud Detection for a genuine labeled fraud problem.
Optional weather/event datasets can be joined later to improve exogenous demand and ETA features.
